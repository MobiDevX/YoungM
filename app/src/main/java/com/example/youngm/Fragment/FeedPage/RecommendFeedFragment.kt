...
import kotlinx.android.synthetic.main.fragment_recommend_feed.*
...
class RecommendFeedFragment : Fragment(),
    UpdateData, OnItemClickListener {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        recyclerRecommendFeed.adapter = adapter
        recyclerRecommendFeed.layoutManager = LinearLayoutManager(context)
        musicDataViewModel = MusicDataViewModel(context, "RecommendFeed")
        progressBar = progressBarRecommend
        updateData()

        swipeRefreshRecommend.setOnRefreshListener {
            swipeRefreshRecommend.isRefreshing = false
            updateData()
        }
    }
...
//            updateData()
    ...
    fun loadPosts(){
        ...
        recyclerRecommendFeed.visibility = View.INVISIBLE
        val url = URLData.MAIN_URL + URLData.GET_RECOMMEND_POSTS
                ...
                override fun onResponse(call: Call, response: Response) {
                    ...
                    if (response.code == 200) {
                        ...
                        val refreshJob: Job = GlobalScope.launch(Dispatchers.Main) {
                            ...
                            recyclerRecommendFeed.visibility = View.VISIBLE
                        }
                        refreshJob.start()
