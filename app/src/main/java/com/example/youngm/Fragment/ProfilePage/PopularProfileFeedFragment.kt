...
import kotlinx.android.synthetic.main.fragment_popular_profile_feed.*
...
class PopularProfileFeedFragment : Fragment(), OnItemClickListener, UpdateData{
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_popular_profile_feed, container, false)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        recyclerPopularProfileFeed.adapter = adapter
        recyclerPopularProfileFeed.layoutManager = LinearLayoutManager(context)
        musicDataViewModel = MusicDataViewModel(context, "PopularFeedProfile")
        postsList = ArrayList()
        loadData()
    }
    ...
    private fun loadData(){
        ...
        val url = URLData.MAIN_URL + URLData.GET_POPULAR_POST_AUTHOR
                ...
                override fun onResponse(call: Call, response: Response) {
                    ...
                    val refreshJob: Job = GlobalScope.launch(Dispatchers.Main) {
                        ...
                        if (postsList.size > 0) {
                            ...
                            textViewEmptyPopularPosts.visibility = View.VISIBLE
                        }
